...
<img src="https://sky.x-gap.ml/d/Config/A3-1.png" width="80%"/>
或者打开[必应搜索](https://cn.bing.com/ )，键入`"游戏名"`+`空格`+`site:byrut.org`，搜索出来的第一个结果就是。
<img src="https://sky.x-gap.ml/d/Config/A3-2.png" width="80%"/>
下拉到这里可以看到游戏种子和游戏大小
<img src="https://sky.x-gap.ml/d/Config/A3-3.png" width="80%"/>
把种子下载下来然后使用迅雷下载BT种子即可，下载速度非常可观
<img src="https://sky.x-gap.ml/d/Config/A3-4.png" width="80%"/>
