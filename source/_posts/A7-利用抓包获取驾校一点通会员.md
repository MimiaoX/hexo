...
<img src="https://x-eta.ml/A7/1.jpg" width="80%">
打开驾校一点通，登录并点击我的页面，发现会员并未开通，回到小黄鸟搜索：
https://vipapi.jxedt.com/store/batchCheckRights
<img src="https://x-eta.ml/A7/2.jpg" width="80%">
点击查看其响应预览，代码含义如下
```
SPEED_VIP_KM4    #科目4会员
...
```
<img src="https://x-eta.ml/A7/3.jpg" width="80%">
返回创建重写器，修改响应，将所有会员有效期向后更改，并把status值改为2
<img src="https://x-eta.ml/A7/4.jpg" width="80%">
<img src="https://x-eta.ml/A7/5.jpg" width="80%">
创建后重写器在插件管理里查看
